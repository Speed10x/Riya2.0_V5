...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'maximize0') # without @ or https://t.me/ 
USERNAME = environ.get('USERNAME', "https://t.me/maximize0") # ADMIN USERNAME

# Database Channel 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001942980809 -1002446479008').split()]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002238440461'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002141866340'))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002149166092'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002221251113')) 
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002218738984'))

# MongoDB 
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Riyav5:Riyav5@riyav5.w4jva.mongodb.net/?retryWrites=true&w=majority&appName=riyav5")
DATABASE_NAME = environ.get('DATABASE_NAME', "riyav5")

# Files index database url
FILES_DATABASE = environ.get('FILES_DATABASE', "mongodb+srv://aero:aero@cluster0.rgv6t6k.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Cluster0')

# Other Channel's
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002167777305'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','0'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002141866340') 
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001986234690')) 

# Added Link Here Not Id 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/riyasupportt')
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/RaxieCatX_Bottt')

# Verification
IS_VERIFY = is_enabled('IS_VERIFY', True)
TUTORIAL = environ.get("TUTORIAL", "https://t.me/testingdb2/10")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "raXBls27RSYrdSsLIpwfjmR8Bm62")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'api.shareus.io')
SHORTENER_API2 = environ.get("SHORTENER_API2", "baf46457888030ccc3d4290d2c167fbec273ce0d")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'api.gplinks.com')
SHORTENER_API3 = environ.get("SHORTENER_API3", "raXBls27RSYrdSsLIpwfjmR8Bm62")
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://married-marena-aerofilms-8547b846.koyeb.app/")
